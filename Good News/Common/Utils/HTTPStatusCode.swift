...
//  Good News
//
//  Created by Ricki Bin Yamin on 11/06/21.
//

//  Referenced from https://gist.github.com/ollieatkinson/322338df8a5220d649ac01ff11e7de12
...
enum HTTPStatusCode: Int, Error {
	...
	/// - to throw undefined error
	case undefinedError = 1000
	...
	/// String description for related status code with proper format
	var description: String {
		var result = String()
		for character in String(describing: self) {
